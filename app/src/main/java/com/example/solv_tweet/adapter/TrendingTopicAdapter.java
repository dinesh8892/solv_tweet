package com.example.solv_tweet.adapter;
...
import com.example.solv_tweet.activities.DisplayTweetActivity;
import com.example.solv_tweet.trendingtopicmodel.Trend;

import java.util.List;

public class TrendingTopicAdapter extends RecyclerView.Adapter<TrendingTopicAdapter.TrendingTopicViewHolder> {
    ...
    public TrendingTopicAdapter(Context context, List<Trend> trends) {
